...
> Discord anti-spam bot, flood raid link filter AI 2026 — free, open-source, easy to set up.

<br>

## ✨ Features

🤖 &nbsp;**AI detection** — machine learning spam classifier

🔗 &nbsp;**Link filter** — block Discord invites and malicious URLs

⚡ &nbsp;**Flood control** — auto-mute users sending too fast

🖼️ &nbsp;**Image spam** — detect repeated image spam

📋 &nbsp;**Global blacklist** — known raider and spammer database

📊 &nbsp;**Threat log** — history of all blocked attempts
